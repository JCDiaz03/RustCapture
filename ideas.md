...
54. Tipografía elegible para el texto: las familias instaladas en el sistema más las que el usuario deje en una carpeta `fonts/` junto al ejecutable, sin necesidad de instalarlas en Windows. Con la caja de edición abierta se cambian en vivo fuente, tamaño, negrita y color.
